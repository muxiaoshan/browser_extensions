...
echo copy dll to IE
if exist "C:\Program Files (x86)\Internet Explorer" goto copy2IEOnX64
if exist "C:\Program Files\Internet Explorer" goto copy2IEOnX86
:copy2IEOnX64
copy /y "%CURRENT_DIR%\mysql.data.dll" "C:\Program Files (x86)\Internet Explorer\mysql.data.dll"
copy /y "%CURRENT_DIR%\itextsharp.dll" "C:\Program Files (x86)\Internet Explorer\itextsharp.dll"
:copy2IEOnX86
copy /y "%CURRENT_DIR%\mysql.data.dll" "C:\Program Files\Internet Explorer\mysql.data.dll"
copy /y "%CURRENT_DIR%\itextsharp.dll" "C:\Program Files\Internet Explorer\itextsharp.dll"
goto end
:notinstalled
